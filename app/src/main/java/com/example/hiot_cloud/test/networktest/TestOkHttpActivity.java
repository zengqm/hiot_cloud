...
//    private static final String basUrl = "http://www.baidu.com/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGetUserInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getUserInfo("1b74b89f2b3c497a86b0eb346c152b95_c3c7e005e8784fe3b66c4bec091cad75_use");
            }
        });
        ...
        btnUpdateEmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                updateEmail("1b74b89f2b3c497a86b0eb346c152b95_c3c7e005e8784fe3b66c4bec091cad75_use",
                        "123test@qq.com");
            }
        });
    }
    ...
    private void login(String userName, String password, String loginCode) {
        OkHttpClient okHttpClient = new OkHttpClient();
        FormBody body = new FormBody.Builder().build();
        String url = basUrl + String.format("/auth/login?username=zqm&password=zqm123&loginCode=app",userName,password,loginCode);
